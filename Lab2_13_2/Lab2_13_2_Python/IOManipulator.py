...
from PhoneCallProcessor import PhoneCallProcessor
        ...
        try:
            ...
            for line in input_file:
                ...
                if(string != " "):
                    ...
                    phone_call_length = PhoneCallProcessor.get_current_phone_call_length(
                        phone_call)
                    if(IOManipulator.__is_fullfilling_creteria(phone_call_length)):
                        output_file.write(
                            PhoneCallProcessor.stringify(phone_call).encode())
        except:
            raise ValueError(
